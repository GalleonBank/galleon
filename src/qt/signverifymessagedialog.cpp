    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Galleon address (e.g. mhN8btKtp3HrXgZJwyBakUzALLZ34nA4J)"));
    ui->pubkeyOut_VM->setPlaceholderText(tr("Click \"Sign Message\" to view public key"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Galleon address (e.g. mhN8btKtp3HrXgZJwyBakUzALLZ34nA4J)"));
    ui->pubkeyIn_VM->setPlaceholderText(tr("Enter the public key used for signing"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter Galleon signature"));
#endif
