...
const QString BITCOIN_IPC_PREFIX("galleon:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click galleon: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start galleon: click-to-pay handler");
    else
...
{
    // clicking on galleon: URLs creates FileOpen events on the Mac:
